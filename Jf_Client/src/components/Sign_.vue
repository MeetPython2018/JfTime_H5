      ...
      <div class="cons">
        <el-main>
          <div class="login-div">
            <div class="logo"></div>
            <div class="title">
              <span @click.prevent="type=0">登录</span>
              <i class="iconfont icon-qiehuan"></i>
              <span @click.prevent="type=1">注册</span>
            </div>
            <div class="fields">
              <div class="username">
            ...
            <button class="signin-button" @click.prevent="type===0 ? SignInLogin():SignUpLogin()">Login</button>
            <div class="link">
              <a href="#">Forgot password ?</a> or <router-link to="/Home">Go To Home</router-link>
            </div>
          </div>
        </el-main>
      </div>
